...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PiecesofEight " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"piecesofeight.org", "dnsseed.piecesofeight.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"piecesofeight.org", "testnet-seed.piecesofeight.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PiecesofEight is probably already running."), addrBind.ToString().c_str());
        else
